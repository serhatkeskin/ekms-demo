function collapseItem(theme: any, ownerState: any) {
  ...
  return {
    ...
    "&:hover": {
      backgroundColor: (transparentSidenav && !darkMode) || whiteSidenav ? grey[200] : rgba(white.main, 0.1),
    },
    [breakpoints.up("xl")]: {
...
function collapseIconBox(theme: any, ownerState: any) {
